...
**TKTK: Describe my-new-awesome-project here.**
...
```
* * * * * ubuntu bash /home/ubuntu/apps/my_new_awesome_project/repository/cron.sh fab $DEPLOYMENT_TARGET cron_jobs.test
```
...
|--------|------|-----|-----|
|my-new-awesome-project|tweet|`location`||
|my-new-awesome-project|facebook|`location`||
|my-new-awesome-project|email|`location`||
|my-new-awesome-project|new-comment||
|my-new-awesome-project|open-share-discuss||
|my-new-awesome-project|close-share-discuss||
|my-new-awesome-project|summary-copied||
|my-new-awesome-project|featured-tweet-action|`action`|
|my-new-awesome-project|featured-facebook-action|`action`|
